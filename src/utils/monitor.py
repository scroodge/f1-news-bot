...
class SystemMonitor:
    ...
    async def check_system_health(self) -> dict[str, Any]:
        ...
        try:
            ...
            failed_checks = [
                check for check in health_status["checks"].values() if not check["status"]
            ]
            if failed_checks:
    ...
    async def _check_system_resources(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": False, "message": f"System resource check failed: {e}", "details": {}}
    ...
    async def _check_database(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": False, "message": f"Database connection failed: {e}", "details": {}}
    ...
    async def _check_ollama(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": False, "message": f"Ollama service unavailable: {e}", "details": {}}
