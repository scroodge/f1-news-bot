...
COMPRESS_PROMPT = """Скароці гэты тэкст да {max_chars} сімвалаў, захаваўшы ўсе галоўныя факты, цытаты і дэталі. Не мяняй стыль, не дадавай тлумачэнняў. Вярні толькі скарочаны тэкст.
