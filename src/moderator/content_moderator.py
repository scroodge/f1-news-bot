...
class ContentModerator:
    ...
    def _is_spam(self, news_item: ProcessedNewsItem) -> bool:
        ...
        return any(re.search(pattern, text, re.IGNORECASE) for pattern in promotional_patterns)
    ...
    def _is_properly_formatted(self, news_item: ProcessedNewsItem) -> bool:
        ...
        return not news_item.content.strip().startswith("http")
